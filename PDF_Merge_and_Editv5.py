...
# body of GUI
my_img = tk.PhotoImage(file = "D:\\users\\gorodetsky\\GIT\\PDF_Merge_and_Edit\\resources\\logo.png")
tk.Label(selector,  image=my_img).grid(row=0, column=0, sticky=stickyFill, pady=3, padx=5)
tk.Label(selector, text="Работа с PDF v 0.5.0").grid(row=0, column=1, pady=5, padx=5)
#nfiles = tk.IntVar()
...
tk.Button(selector, text="Разбить PDF файл в папку", command=boomPages).grid(row=1, column=0, columnspan=2, sticky=stickyFill, pady=3, padx=5)
